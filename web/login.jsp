...
<html>
 ...
 <body class="flex-block items-center  min-h-screen bg-gray-100">
    ...
    <form action="LoginUserServlet" method="post" class="bg-white p-6 rounded-lg shadow-md w-full max-w-sm h-full max-h-sm my-20 mx-auto fade-in">
        ...
        <button type="submit" class="w-full py-2 px-4 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Login</button>
