...
<html>
    ...
    <form action="Main" method="post" class="bg-white p-6 rounded-lg shadow-md w-full max-w-sm h-full max-h-sm my-16 mx-auto fade-in">
        ...
        <div class="mb-4">
         ...
         <div class="mb-4">
            <label for="txtrepassword" class="block text-gray-700">Confirm password  <span class="my-1 text-red-600">${message1}</span></label>
            
            <input type="password" id="txtpassword" name="txtrepassword" placeholder="Confirm password" required=""
                   class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:ring-1 focus:border-indigo-500 sm:text-sm" />
        </div>
        
        <button type="submit" class="mt-2 w-full py-2 px-4 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50" name="action" value="6">Register</button>
        <div class="flex justify-end mt-4">
            
            <a href="Main?action=2" class=" text-blue-500 hover:text-blue-700 flex items-center transition duration-300 ease-in-out transform hover-move-left">
