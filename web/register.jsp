...
<html>
    ...
    <form action="LoginUserServlet" method="post" class="bg-white p-6 rounded-lg shadow-md w-full max-w-sm h-full max-h-sm my-20 mx-auto">
        ...
        <button type="submit" class="mt-2 w-full py-2 px-4 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Submit</button>
        <div class="flex justify-end mt-4">
            
            <a href="login.jsp" class=" text-blue-500 flex items-center">
